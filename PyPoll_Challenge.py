...
file_to_load = '/Users/pimchanyachitsanga/Desktop/Data Analysis/Election_Analysis/Resources/election_results.csv'
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if counties_name not in counties:
            ...
            county_vote[counties_name] = 0

        # 5: Add a vote to that county's vote count.
        county_vote[counties_name] += 1
